...
class ImageFolder(Dataset):
    ...
    def get_name(self, idx):
        return os.path.splitext(os.path.basename(self.get_path(idx)))[0]
...
class PairedImageFolders(Dataset):
    ...
    def get_meta(self, idx):
        return {
            'name': self.dataset_1.get_name(idx),
            'img_path': self.dataset_1.get_path(idx),
            'gt_path': self.dataset_2.get_path(idx)
        }
